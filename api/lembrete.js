...
exports.read = function(req, res) {
	...
	req.getConnection(function(err,connection){
		connection.query('SELECT l.titulo, l.dataInicio, l.dataTermino, l.vPrevisto, sum( d.valor)as vGasto , l.status, l.id_user, l.token FROM lembretes l JOIN usuarios u ON l.id_user = u.id  LEFT JOIN despesas d ON d.id_viagem = l.id_lembrete  WHERE l.token = ? group by 1,2,3,4,6,7,8',[req.token],function(err,result){
